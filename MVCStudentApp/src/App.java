...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        FileModelClass fmClass = new FileModelClass("StudentDB.csv"); //создали файл для записи

        fmClass.saveAllStudentToFile(studList); // записали данные из хранилища в файл

        iGetModel hashModel = new ModelClassHash(studList); // создали лист студентов в виде хранилища типа HashMap     
        

        ControllerClass controller = new ControllerClass(
            new ArrayList<>(Arrays.asList(hashModel)), "en");

        controller.run(); // реализация логики программы
    }
}
